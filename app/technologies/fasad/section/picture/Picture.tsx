    ...
    <section>
      <div className="container">
        ...
        <p className={styles.descr}> 
          Старовинна будівля виконана з цегли з дуже гарним цегляним орнаментом, але протягом десятиліть фасад цієї будівлі став брудним, частково руйнуються та втрачає свою первинну красу.
        </p>
