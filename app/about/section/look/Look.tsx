      ...
      <div className="container">
        <div className={styles.inner}>
          ...
          <div className={styles.info}>
            <h3>Шукаємо</h3>
            <p>
              Слідкуємо за сучасними трендами, постійно навчаємося , подорожуємо по світу-по виставках та конференціях та знаходимо корисні, афективні ТЕХНОЛОГІЇ, які можуть покращити якість, організацію будівництва та життя Будівельників та їх Клієнтів.
            </p>
          </div>
        </div>
      </div>
