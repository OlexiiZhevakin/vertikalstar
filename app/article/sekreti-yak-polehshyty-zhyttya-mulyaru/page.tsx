    ...
    <article>
      ...
      <section className={styles.blog}>
        <div className="container">
          ...
          <p className={styles.text}>
            Від чого душа муляра співає?  Коли все сперечається.  Ріштування  виставлено, матеріал заготовлений, підсобники моторні, розчин для кладки зручний та еластичний.  У таких умовах робота сперечається і можна досягти високої швидкості .  "Гнати та гнати куби".  А т.к.  муляру платять за кількість покладеної цегли,це  значить заробляти більше.
          </p>
          <figure>
            <picture>
          ...
          <p className={styles.text}>
            Будівельна наука вигадала вже спеціальні добавки саме для будівельних розчинів, які виключають усі побічні дії та значно покращують якість будівельних розчинів.  З однієї із таких добавок хочу познайомити Вас у цій статті.  Це "Домоліт", виробництва заводу Ізомат(Греція).
          </p>
