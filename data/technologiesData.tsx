const TechnologiesData = [{
    image: '/img/technologies/tekhnolohiya-hidroizolyatsiyi.jpg',
    imageWebp: '/img/technologies/tekhnolohiya-hidroizolyatsiyi.webp',
    title: 'Гідроізоляція',
    link: '/technologies/hidroizolyatsiya',
  },
  {
